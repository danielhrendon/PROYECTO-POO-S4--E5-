 ...
 * @author PC
 */
public class muestraDama extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        posServ = new javax.swing.JTextField();
        ...
        jLabel1.setText("DAMA");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 400, 30));

        posServ.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        posServ.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                posServActionPerformed(evt);
            }
        });
        posServ.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                posServKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                posServKeyTyped(evt);
            }
        });
        jPanel1.add(posServ, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, 70, 30));
        ...
        btnAceptarLayout.setHorizontalGroup(
            ...
            .addComponent(aceptar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(btnAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 260, 40));
        ...
        btnCancelarLayout.setHorizontalGroup(
            ...
            .addComponent(cancelar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 260, -1));

        jLabel2.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel2.setText("Digite la posición de la sucursal:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 410, 30));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes1/4.png"))); // NOI18N
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-40, 0, 170, 150));

        jScrollPane1.setViewportView(muestraA);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 0, 400, 330));
        ...
        btnAceptar1Layout.setHorizontalGroup(
            ...
            .addComponent(aceptar1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(btnAceptar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 260, 40));
        ...
        btnCancelar1Layout.setHorizontalGroup(
            ...
            .addComponent(cancelar1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(btnCancelar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 260, -1));

        jLabel3.setFont(new java.awt.Font("Roboto Black", 0, 24)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Mostrar información");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 20, 220, 30));
    ...
    private void posServActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_posServActionPerformed
    {//GEN-HEADEREND:event_posServActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_posServActionPerformed
    ...
    {//GEN-HEADEREND:event_aceptarMouseClicked
        try
        {
            if (!"".equals(posServ.getText()))
            {
                if (Integer.parseInt(posServ.getText()) < obj.getAutoServicios().size() && Integer.parseInt(posServ.getText()) >= 0)
                {
                    muestraA.setText(obj.consServicio(Integer.parseInt(posServ.getText())));
                } else
                {
    ...
    private void posServKeyTyped(java.awt.event.KeyEvent evt)//GEN-FIRST:event_posServKeyTyped
    {//GEN-HEADEREND:event_posServKeyTyped
        Validaciones.validaEntero(evt, 3, posServ.getText());
    }//GEN-LAST:event_posServKeyTyped

    private void posServKeyPressed(java.awt.event.KeyEvent evt)//GEN-FIRST:event_posServKeyPressed
    {//GEN-HEADEREND:event_posServKeyPressed
    ...
    }//GEN-LAST:event_posServKeyPressed
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(muestraDama.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField posServ;
