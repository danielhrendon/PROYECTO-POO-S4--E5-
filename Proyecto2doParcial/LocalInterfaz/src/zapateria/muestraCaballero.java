 ...
 * @author PC
 */
public class muestraCaballero extends javax.swing.JFrame
{

    /**
     * Creates new form vtnASucu
     */
    public muestraCaballero()
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        posPin = new javax.swing.JTextField();
        ...
        jLabel1.setText("CABALLERO");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 390, 30));

        posPin.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        posPin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                posPinActionPerformed(evt);
            }
        });
        posPin.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                posPinKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                posPinKeyTyped(evt);
            }
        });
        jPanel1.add(posPin, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 130, 60, 30));
        ...
        btnAceptarLayout.setHorizontalGroup(
            ...
            .addComponent(aceptar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(btnAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 250, 40));
        ...
        btnCancelarLayout.setHorizontalGroup(
            ...
            .addComponent(cancelar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 250, -1));

        jLabel2.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel2.setText("Digite la posición de la sucursal:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 410, 30));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes1/5.png"))); // NOI18N
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 110, 120));

        jScrollPane1.setViewportView(muestraA);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 0, 380, 300));
        ...
        btnAceptar1Layout.setHorizontalGroup(
            ...
            .addComponent(aceptar1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(btnAceptar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 250, 40));
        ...
        btnCancelar1Layout.setHorizontalGroup(
            ...
            .addComponent(cancelar1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(btnCancelar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 250, -1));

        jLabel3.setFont(new java.awt.Font("Roboto Black", 0, 24)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Mostrar información");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 390, 30));
    ...
    private void posPinActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_posPinActionPerformed
    {//GEN-HEADEREND:event_posPinActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_posPinActionPerformed
    ...
    {//GEN-HEADEREND:event_aceptarMouseClicked
        try
        {
            if (!"".equals(posPin.getText()))
            {
                if (Integer.parseInt(posPin.getText()) < obj.getAutoServicios().size() && Integer.parseInt(posPin.getText()) >= 0)
                {
                    muestraA.setText(obj.consultaAgen(Integer.parseInt(posPin.getText())));
    ...
    private void posPinKeyTyped(java.awt.event.KeyEvent evt)//GEN-FIRST:event_posPinKeyTyped
    {//GEN-HEADEREND:event_posPinKeyTyped
        Validaciones.validaEntero(evt, 3, posPin.getText());
    }//GEN-LAST:event_posPinKeyTyped

    private void posPinKeyPressed(java.awt.event.KeyEvent evt)//GEN-FIRST:event_posPinKeyPressed
    {//GEN-HEADEREND:event_posPinKeyPressed
        ...
        if (evt.getKeyChar() == '\n')
        {
            if (!"".equals(posPin.getText()))
            {
                if (Integer.parseInt(posPin.getText()) < obj.getAutoServicios().size() && Integer.parseInt(posPin.getText()) >= 0)
                {
                    muestraA.setText(obj.consPintura(Integer.parseInt(posPin.getText())));
                } else
                {
                    Mensaje.error(this, "No existe esa posición de sucursal.");
                }
    ...
    }//GEN-LAST:event_posPinKeyPressed
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(muestraCaballero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField posPin;
